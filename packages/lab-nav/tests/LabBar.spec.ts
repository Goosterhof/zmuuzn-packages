...
describe('LabBar', () => {
    it('should render the brand mark pill with zmuuzn wordmark', () => {
        const wrapper = mount(LabBar, {
            props: {currentExperiment: 'war-table', user: {name: 'Goos'}, localNav: []},
    ...
    it('should render the user menu with the user name', () => {
        const wrapper = mount(LabBar, {
            props: {currentExperiment: 'gatekeeper', user: {name: 'Goos'}, localNav: []},
            global: {plugins: [createTestRouter()]},
        });
    ...
    it('should render slot content in local-nav-end', () => {
        const wrapper = mount(LabBar, {
            props: {currentExperiment: 'gatekeeper', user: {name: 'Goos'}, localNav: [{label: 'Home', to: '/'}]},
            slots: {'local-nav-end': '<span data-test="slot">Admin Badge</span>'},
            global: {plugins: [createTestRouter()]},
        });
