...
const {current, position} = defineProps<{current: ExperimentId; position?: 'bottom-right' | 'bottom-left'}>();
    ...
    <div class="lab-map-root">
        ...
        >
            ...
            >
                ...
                <line x1="12" y1="2" x2="12" y2="10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                ...
                <line x1="12" y1="1" x2="12" y2="9" stroke="#F0D040" stroke-width="2" stroke-linecap="round" />
                <!-- Center dot (gold) -->
