...
<template>
    <div
        ...
        items-stretch
        overflow-hidden
        :style="{border: '2px solid #1A1A1A', boxShadow: '2px 2px 0 rgba(0,0,0,0.3)'}"
    >
        <!-- Segment 1: Stars -->
        <div
            flex
            items-center
            :style="{backgroundColor: '#C8102E', padding: sizeTokens.starsPadding, borderRight: '2px solid #1A1A1A'}"
        >
        ...
        <div
            ...
            flex
            items-center
            :style="{backgroundColor: '#1A1A1A', padding: sizeTokens.appNamePadding, borderLeft: '2px solid #1A1A1A'}"
        >
            <span
                lab-font-display
                :style="{
